...
for n=1:num_iter
    ...
    m_in(n)=all_solve_data((n-1)*num_pop+m).EM_input((n-1)*num_pop+m).m_in;
    m_width(n)=all_solve_data((n-1)*num_pop+m).EM_input((n-1)*num_pop+m).m_width;
...
for n=1:num_iter*num_pop  
    ...
    m_in(n)=all_solve_data(n).EM_input(n).m_in;
    m_width(n)=all_solve_data(n).EM_input(n).m_width;
