...
if mode==4
    ...
    DesignsParams(1).variables(6).max_value = 4;
    ...
    DesignsParams(1).variables(8).value = 1.15;
    DesignsParams(1).variables(8).max_value = 1.25;
...
elseif mode==7
   DesignsParams(1).variables(1).name = 'D_arc_2';
    ...
    DesignsParams(1).variables(8).name = 'arigap';
    DesignsParams(1).variables(8).value = 3;
    DesignsParams(1).variables(8).max_value = 5;
    DesignsParams(1).variables(8).min_value = 3;
