...
mode =4; %hall sensor-resolver

DesignsParams=Geo_boundary_condition_15(mode)
...
%% run it
[x,f,nf] = DEoptimize_ECCE('Eval_resolver_ECCE_15','report_fea_results', AlgorithmParams)
