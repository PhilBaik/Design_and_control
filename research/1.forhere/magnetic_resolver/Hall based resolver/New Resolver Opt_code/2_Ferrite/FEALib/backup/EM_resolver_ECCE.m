...
R=1 %In order to check if the code is entering here

if mode == 1
    D_stator_outer=para(1);
    w_teeth=para(2);
    shoe_1=para(3);
    shoe_2=para(4);
    airgap = para(5);
...
if mode ==2
    ...
    airgap = para(2);
    m_thickness=para(3);
    pole_arc_ratio=para(4);
    D_ri1=para(5);
    D_ri2 = para(6);
    a_ri = para(7);
    D_stator_outer=para(8);
end
if mode ==3
    D_ro1 = para(1);
    airgap = para(2);
...
if mode == 6
    D_rotor_outer=para(1);
    D_rotor_inner=para(2);
    deg_shape=para(3);
    deg_barrier=para(4);
    deg_round = para(5);
    m_thickness = para(6);
...
if mode==4
    ...
    mi_selectcircle(0,0,(D_ro2-0.1)*0.5,4);
    mi_mirror2(0,0,0,10,4);
    mi_selectcircle(0,0,(D_ro2-0.1)*0.5,4);
    mi_copyrotate2(0,0,360/pole_number,pole_number,4);
    
       %magnet
    mi_addnode(-mag_width/2,D_ro1*0.5-(mag_dis+m_thickness*0.5));
    mi_addnode(-mag_width/2,D_ro1*0.5-(mag_dis-m_thickness*0.5));
    mi_addnode(+mag_width/2,D_ro1*0.5-(mag_dis+m_thickness*0.5));
    mi_addnode(+mag_width/2,D_ro1*0.5-(mag_dis-m_thickness*0.5));
    mi_addsegment(-mag_width/2,D_ro1*0.5-(mag_dis+m_thickness*0.5),-mag_width/2,D_ro1*0.5-(mag_dis-m_thickness*0.5));
    mi_addsegment(-mag_width/2,D_ro1*0.5-(mag_dis-m_thickness*0.5),+mag_width/2,D_ro1*0.5-(mag_dis-m_thickness*0.5))
    mi_addsegment(+mag_width/2,D_ro1*0.5-(mag_dis+m_thickness*0.5),+mag_width/2,D_ro1*0.5-(mag_dis-m_thickness*0.5))
    mi_addsegment(+mag_width/2,D_ro1*0.5-(mag_dis+m_thickness*0.5),-mag_width/2,D_ro1*0.5-(mag_dis+m_thickness*0.5))
    
    mi_selectrectangle(-mag_width/2,D_ro1*0.5-(mag_dis+m_thickness*0.5),mag_width/2,D_ro1*0.5-(mag_dis-m_thickness*0.5),4);
    mi_copyrotate2(0,0,360/pole_number,pole_number,4);
    for z=1:(pole_number/2)
        mi_clearselected();
...
% winding_elec_angle=0:72:720
% winding_elec_angle+36