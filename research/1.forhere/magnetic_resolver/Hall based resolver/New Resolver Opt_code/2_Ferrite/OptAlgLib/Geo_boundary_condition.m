...
elseif mode==4
    ...
    DesignsParams(1).variables(8).value = 1.1;
    DesignsParams(1).variables(8).max_value = 1.1;
...
elseif mode==6
    ...
    DesignsParams(1).variables(8).name = 'b_th_2';
    DesignsParams(1).variables(8).value = 2;
    DesignsParams(1).variables(8).max_value = 3;
    DesignsParams(1).variables(8).min_value = 1;
