...
%% geometry
sensor_space = 20;
D_rotor_outer= 56; % outer boundary of simulation
...
Num_series=1;
Num_parallel=1;
auto = 0; %%% if you want to make mesh be auto.
mesh_size = 0.5;
if(auto == 1)
    mesh_size = 0;
end
...
x0=0;
y0=0;
mi_makeABC(7,D_stator_outer/2,x0,y0,0)
...
% z=1;
% mi_clearselected();
% mi_addblocklabel(0,(D_rotor_inner+m_thickness)*0.5-1);
% mi_selectlabel(0,(D_rotor_inner+m_thickness)*0.5-1);
