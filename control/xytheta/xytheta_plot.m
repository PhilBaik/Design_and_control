...
load("xytheta_output_sensor_r48_kg3999_20220624_1115.mat")
% load("hi2.mat")
%% 
x1 = x_mid+2;
y0 = y_mid;
date = datestr(now,'yyyymmdd_HHMM');
theta_check = theta_elec_in;
...
theta_in_elecx1y0 = zeros(1,length(theta_r_index));

for i = theta_r_index
    if theta_elec_in(1,i)>180
        theta_in_elecx1y0(1,i)=theta_elec_in(1,i)-360;
    else
        theta_in_elecx1y0(1,i)=theta_elec_in(1,i);
    end
end
